...
/* Stub functions for supercall commands not implemented in this older susfs4ksu snapshot */
#ifdef CONFIG_KSU_SUSFS_SUS_PATH
...
/* Additional stub functions/symbols for supercall commands not implemented in this older susfs4ksu snapshot */
...
DECLARE_WORK(susfs_extra_works, susfs_extra_work_fn);
